...
namespace WinTail
{
    ...
    public class FileValidatorActor : UntypedActor
    {
        ...
        //public FileValidatorActor(IActorRef consoleWriterActor, IActorRef tailCoordinatorActor)   Replaced with ActorSelection version
        ...
        protected override void OnReceive(object message)
        {
            ...
            else
            {
                ...
                if (valid)
                {
                    ...
                    // start coordinator
                    //_tailCoordinatorActor.Tell(new TailCoordinatorActor.StartTail(msg, _consoleWriterActor));     replaced with ActorSelection version
